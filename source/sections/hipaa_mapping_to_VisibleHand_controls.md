# HIPAA Mappings to VisibleHand Controls

Below is a list of HIPAA Safeguards and Requirements and the VisibleHand controls in place to meet those.

| **Administrative Controls** HIPAA Rule | VisibleHand Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | VisibleHand Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | VisibleHand Control
---------------- | ----------------
