# HIPAA Mappings to C3LX Controls

Below is a list of HIPAA Safeguards and Requirements and the C3LX controls in place to meet those.

| **Administrative Controls** HIPAA Rule | C3LX Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | C3LX Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | C3LX Control
---------------- | ----------------
